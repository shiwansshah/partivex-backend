...
namespace Partivex.Infrastructure.Migrations
{
    ...
    [Migration("20260426163651_AddCustomerVehicleModule")]
    partial class AddCustomerVehicleModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Partivex.Domain.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Partivex.Domain.Entities.Vehicle", b =>
                {
                    b.HasOne("Partivex.Domain.Entities.Customer", "Customer")
                        .WithMany("Vehicles")
