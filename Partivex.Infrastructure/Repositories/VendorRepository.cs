...
public sealed class VendorRepository : IVendorRepository
{
    ...
    public Task<Vendor?> GetActiveByIdAsync(int id, CancellationToken cancellationToken = default)
    {
        return _dbContext.Vendors.FirstOrDefaultAsync(vendor => vendor.Id == id && vendor.IsActive, cancellationToken);
    }
